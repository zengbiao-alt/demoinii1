...
public class CalendarServiceImpl implements CalendarService {
    ...
    @Autowired
    private hospitalMapper hospitalMappers;
    @Autowired
    private OrderMapper ordersMappers;

    //生成预约日历
    @Override
    public List<CalendarResponseDto> listAppointmentCalendar(CalendarRequestDto dto) throws ParseException {
        //获取预约日期列表
    ...
    //获取30天预约日期列表
    @Override
    public List<CalendarResponseDto> getCalendarList30(Integer hpId) throws ParseException {
        ...
        List<CalendarResponseDto> calendarList30 = ordersMappers.listOrdersAppointmentNumber(parameList);

        //根据医院编号，获取预约规则，就能获取每天最多预约人数
//		String[] strArr = hospitalMappers.getHospitalById(hpId);
